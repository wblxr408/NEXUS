...
def generate_launch_description():
    ...
    return LaunchDescription([
        DeclareLaunchArgument("hardware_config", default_value=str(share / "config/hardware_user_v02.yaml")),
        ...
        Node(package="nexus_pi_readonly_ingress", executable="camera_file_node.py",
             parameters=[{"camera_dir": LaunchConfiguration("camera_dir"),
                          ...
                          "remote_port": LaunchConfiguration("camera_remote_port"),
                          "intrinsics_file": LaunchConfiguration("intrinsics_file")}], output="screen"),
    ])
