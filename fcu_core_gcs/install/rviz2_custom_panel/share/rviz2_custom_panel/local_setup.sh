...
: ${AMENT_CURRENT_PREFIX:="/root/nexus_workspace/NEXUS/fcu_core_gcs/install/rviz2_custom_panel"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rviz2_custom_panel/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rviz2_custom_panel/environment/path.sh"
