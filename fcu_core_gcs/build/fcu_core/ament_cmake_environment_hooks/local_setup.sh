...
: ${AMENT_CURRENT_PREFIX:="/root/nexus_workspace/NEXUS/fcu_core_gcs/install/fcu_core"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/fcu_core/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/fcu_core/environment/path.sh"
