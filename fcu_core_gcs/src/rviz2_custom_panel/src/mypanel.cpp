...
void rviz2_custom_panel::Rviz2Panel::CreateNode()
{
    ...
    cmd_pub = node->create_publisher<std_msgs::msg::Int16>("/fcu_bridge/command", 100);
...
rviz2_custom_panel::Rviz2Panel::Rviz2Panel(QWidget *parent)
{
    ...
    connect(button_crossing1, &QPushButton::clicked, [this]() {
        std_msgs::msg::Int16 msg;
        msg.data = 8;
        cmd_pub->publish(msg);
    ...
    connect(button_crossing2, &QPushButton::clicked, [this]() {
        std_msgs::msg::Int16 msg;
        msg.data = 9;
        cmd_pub->publish(msg);
    ...
    connect(button_crossing3, &QPushButton::clicked, [this]() {
        std_msgs::msg::Int16 msg;
        msg.data = 10;
        cmd_pub->publish(msg);
    ...
    connect(button_crossing4, &QPushButton::clicked, [this]() {
        std_msgs::msg::Int16 msg;
        msg.data = 11;
        cmd_pub->publish(msg);
    ...
    connect(button_spin, &QPushButton::clicked, [this]() {
        std_msgs::msg::Int16 msg;
        msg.data = 12;
        cmd_pub->publish(msg);
    ...
    connect(button_stop_track, &QPushButton::clicked, [this]() {
        std_msgs::msg::Int16 msg;
        msg.data = 1013;
        cmd_pub->publish(msg);
